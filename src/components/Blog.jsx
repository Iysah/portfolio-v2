  ...
  return (
    <>
      <motion.div variants={textVariant()}>
        <h3 className={`${styles.sectionHeadText}`}><span className='section__gradient'>Like i said, I create contents </span> 🎙️ </h3>
        <p className='text-secondary font-[16px] mt-4 leading-[30px]'>I host Founders weekly, both successful ones and those that failed. A podcast dedicated to exploring the fascinating world of digital products and the innovators behind them..</p>
      </motion.div>
